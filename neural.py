...
training_set = train_datagen.flow_from_directory('E:\Elephant_classification\raw-img\..',
target_size = (64, 64),
batch_size = 32,
class_mode = 'binary')
test_set = test_datagen.flow_from_directory('E:\Elephant_classification\raw-img\..',
target_size = (64, 64),
batch_size = 32,
class_mode = 'binary')
